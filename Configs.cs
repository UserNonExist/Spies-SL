...
public class Configs : IConfig
{
    ...
    [Description("Maximum cap for the chance for the spy to spwan in spawnwave.")]
    ...
    [Description("Maximum cap for the chance for the second spy to spwan in spawnwave.")]
    ...
    [Description("Duration of spy being undetectable at all. (shooting spy will not show hit mark or damage, time starts when spy is spawned)")]
    public int UndetectableDuration { get; set; } = 60;
    [Description("Duration of spy being invulnerable to other team damage. (shooting spy will show hit mark, time starts when spy spawned)")]
