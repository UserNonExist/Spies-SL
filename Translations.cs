...
public class Translations : ITranslation
{
    ...
    public string DetectableMessage { get; set; } = "Other team still see you as normal, but they can now see hit mark when they shoot you.";
    public string VulnerableMessage { get; set; } = "\n\nThe other team can now damage/kill you.";
